#' svm01xht: Support Vector Machine (SVM) for Binary Classification Model with Hypothesis Testing Evaluation
#'
...
#'  \item The `select_correlated_features()` function allows users to select meaningful features by analyzing the correlations between features and the binary label.
